...
public class ProductService {
    private Collection<ProductHandler<? extends Product>> productHandlers;

    @Autowired
    public ProductService(Collection<ProductHandler<? extends Product>> productHandlers) {
        super();
    ...
    public void processProduct(Product product) {
        for (ProductHandler productHandler : productHandlers) {
            if (productHandler.supports(product)) {
                productHandler.printMe(product);
            }
        }
    }
