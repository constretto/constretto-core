...
Constretto is build with maven, so if you are using maven, you can simply add Constretto as dependencies in your pom:
...
h2. How to use the Constretto Java API
...
Now you can query your configuration using the methods in the ConstrettoConfiguration interface like in the examples below:
<pre>
	// Simple lookup
...
h2. Configuration Injection

Im much the same way as dependency injection work in e.g. Spring and Guice, Constretto allows you to inject configuration into your classes.
...
<pre>
	public class DataSourceConfiguration {
	    ...
	    @Configure
	    public void configureMe(String url, @Configuration(expression = "password") String secret) {
	        this.myUrl = url;
...
h2. Use with the Spring framework
...
Constretto currently supports 4 Configuration sources, and the following sections shows how these are used, and how you may tag 
