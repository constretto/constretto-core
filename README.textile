...
!https://travis-ci.org/constretto/constretto-core.png(Build Status)!:https://travis-ci.org/constretto/constretto-core

h2. What's new in 2.1
...
h3. Examples of the new ConstrettoRule
...
h4. Integration with Constretto-Spring
