...
import org.constretto.spring.assembly.helper.service.genericcollections.product.Milk;
 ...
 */
@Component
public class MilkHandler implements ProductHandler<Milk> {

    public void printMe(Milk product) {
