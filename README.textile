...
<pre>
	#
	# to use this in your code : List<String> strings = config.evaluateToList(String.class,"anArrayOfStrings")
    #
	anArrayOfStrings = ["one","two","three"]
	
	#
	# to use this in your code : List<Integer> ints = config.evaluateToList(Integer.class,"anArrayOfInts")
    #
	anArrayOfInts = [1,2,3]
	
	#
	# to use this in your code : Map<String,Integer> map = config.evaluateToMap(String.class,Integer.class,"mapOfStringAndInt")
    #
	mapOfStringAndInt = {"keyOne":1,"keyTwo":2}
	
	#
	# to use this in your code : Person p = config.evaluateWith(new PersonConverter(),"aPerson")
...
Please use the JIRA issue tracker at "http://constretto.org":http://constretto.jira.com/browse/CC
